				...
				<div class="col-md-12">    
					<div class="form-group">
						...
						<div style="text-align: right">
							<label>
							<button onclick="return prosesAdjust()" type="submit" class="btn btn-danger">Proses Adjustment Stok</button>
							</label>
						</div>
					</div>
				</div>
...
<script>
	...
	function prosesAdjust(){
		var gudang = $("#gudang_id").val();
		$.get('<?= base_url()?>api/APIAdjust/proses/?gudang_id='+gudang,
